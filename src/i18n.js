...
const EN = {
  ...
  '开启7d、30d长期统计': 'Enable 7d/30d stats',
  '即将重置': 'Resetting soon',
  ...
  '隐藏区 · 不在面板显示，拖到下方启用': 'Hidden · drag below to enable',
  '展开区 · 展开时显示': 'Expanded · shown when expanded',
  '固定区 · Mini 也保留': 'Pinned · kept in Mini mode',
  '隐藏区（顶部）· 不在面板显示': 'Hidden (top) · not shown on panel',
  ...
  '由官方实验「AI session titles」自动生成。未开启时点击下方复制提示词，粘贴到 kimi web 对话框发送，让 kimi 自动完成配置；完成后运行 /reload 生效。': 'Generated by the official Kimi CLI experiment "AI session titles". If it is not enabled yet, click below to copy a prompt and paste it into the kimi web chat — kimi will update the config for you; run /reload afterwards to apply.',
  '复制提示词': 'Copy prompt',
